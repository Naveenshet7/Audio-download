...
# Create a separate button for submitting the URL
if st.button("Enter"):
    # Process the video URL when the button is clicked
    st.write("Now click on the below image to download")
...
if video_url:
    ...
    # Download audio for the provided link
